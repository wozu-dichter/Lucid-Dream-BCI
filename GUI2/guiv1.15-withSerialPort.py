...
class GUI:
    def __init__(self, parentWindow, count=0, clenchingTime=3000, restingTime=2000): #milliseconds
       ...
       'free timing clench teeth' : bytearray([13]),
       'short time' : bytearray([14]),
       'regular time' : bytearray([15]),
       'long time' : bytearray([16]),
       'long rest' : bytearray([17])
	   }
  	   #====== Serial Port Connection =======
...
#%% ============================= Special Functions ======================
    def action_text_event_creator(self, textaction, event_text, event_type='normal', append=False, relx=0.5, rely=0.5):
        ...
        self.port.write(self.BYTEVALUES[event_text]) #!!!!!!!!!!! event !!!!!!!!!!!!!!!!
