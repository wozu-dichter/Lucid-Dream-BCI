...
class tkinterApp(tk.Tk): 
    ...
    def __init__(self, *args, **kwargs):  
        ...
        for F in (StartPage, DreamBCI, DreamSpeech): 
...
class StartPage(tk.Frame): 
    ...
    def __init__(self, parent, controller):  
        ...
        # grid 
        label.grid(row = 0, column = 1, padx = 550, pady = 20)  
        
        img = ImageTk.PhotoImage(Image.open("follow_the_whiterabbit.png"))
        # img = ImageTk.PhotoImage(file='follow_the_whiterabbit.png')
        panel = tk.Label(self, image = img, highlightthickness = 0, borderwidth=0)
        panel.image = img
        panel.grid(row = 1, column = 1, padx = 550, pady = 10)  
        ...
        btnDreamBCI = tk.Button(self, text ="Dream BCI", command = lambda : controller.show_frame(DreamBCI), \
                                bg="black", fg="white", width = 150, height = 5, font=20) 
      
        # putting the button in its place by 
        # using grid 
        btnDreamBCI.grid(row = 2, column = 1, padx = 550, pady = 10) 
   
        ## button to show frame 2 with text layout2 
        btnSpeech = tk.Button(self, text ="Dream Speech", command = lambda : controller.show_frame(DreamSpeech), \
                              bg="black", fg="white", width = 150, height = 5, font=20) 
        
        # putting the button in its place by 
        # using grid 
        btnSpeech.grid(row = 3, column = 1, padx = 550, pady = 10) 
        ...
        # putting the button in its place by 
        # using grid 
        btnExit.grid(row = 4, column = 1, padx = 550, pady = 10)    
...
#%% ==================== User Interface Initiation ====================   
    def initialize_user_interface(self, controller):
        ...
        self.btnExit = Button(self, text="Exit", bg="black", fg="white", font=custom_font, command=lambda: controller.exit())
        self.btnExit.grid(column=4, row=0)
        self.btnReset = Button(self, text="Reset", bg="black", fg="white", font=custom_font, command=lambda: controller.reset_dreamSpeech())
        self.btnReset.grid(column=5, row=0)
        self.btnReset.config(state = DISABLED)
        self.btnMainMenu = Button(self, text="Main Menu", bg="black", fg="white", font=custom_font, \
                                  command=lambda: controller.show_frame(StartPage))
...
#%% ========================== Button Actions ===========================
    ...
    def change_wordPairs(self, event):
        ...
        self.textLog.set('Word Pairs has changed')
        self.lbl4.after(self.textLogTime, self.log_delete)
        #==== Logging =====
...
#%% ========================= Finish Protocols ==================================
    def finish_protocol(self):
        ...
        #==== Pickle =====
        pickle.dump(self.allLogData, open('Log Data/Dream Speech/' + 'allLogData_' + str(dateTime), 'wb'))
        pickle.dump(self.allInitialDateTimes, open('Log Data/Dream Speech/' + 'allInitialDateTimes_' + str(dateTime), 'wb'))
        #==== Pickle =====
        '''=========== Save Data ============'''
